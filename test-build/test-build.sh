...
./rancher-compose --access-key E0F535B1D46D84442A4F --secret-key bWySMz9vy9zcMxuhS3XBPg8hjbxVnt3k7nDsXaZo -p python-redis-demo-build3 up --pull -d --upgrade pyapp   
